...
from import_vrm import extract_texture_images
...
# vrm file path
filepath = "C:/Users/TeamVRAN/Downloads/bijin.vrm"
copy_filepath = "C:/Users/TeamVRAN/Downloads/bijin1.vrm"
texture_dir = "C:/Users/TeamVRAN/Downloads/Textures"
model_title = "0"

extract_texture_images(filepath, texture_dir, model_title)

target_texture_dir = texture_dir + '/' + 'tex_{}/'.format(model_title)
glb_filepath = "C:/Users/TeamVRAN/Downloads/bijin.glb"
obj_path =  "C:/Users/TeamVRAN/Downloads/bijin_ver.obj"
shutil.copyfile(filepath, copy_filepath)
if not os.path.exists(glb_filepath):
    os.rename(copy_filepath, glb_filepath)

auto_materials(glb_filepath, target_texture_dir, obj_path)
